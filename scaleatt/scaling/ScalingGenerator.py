from scaleatt.scaling.CVScaler import CVScaler
from scaleatt.scaling.PillowScaler import PillowScaler
from scaleatt.scaling.TFImageScaler import TFImageScaler
